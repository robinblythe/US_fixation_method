...
all_medicare <- cbind(total[,1], total[,c(2:7)] / (sum(unlist(prev))/286861))
...
p_all +
  ...
  annotate("text", x = -5000, y = 12000000, label = "A") +
  annotate("text", x = 5000, y = 12000000, label = "B") +
  annotate("text", x = -5000, y = -12000000, label = "C") +
  annotate("text", x = 5000, y = -12000000, label = "D") +
  ...
  p_ha +
  geom_point(aes(x = QALYs, y = Costs, colour = Strategy), alpha = 0.1) +
  annotate("text", x = -2000, y = 4500000, label = "A") +
  annotate("text", x = 2000, y = 4500000, label = "B") +
  annotate("text", x = -2000, y = -4500000, label = "C") +
  annotate("text", x = 2000, y = -4500000, label = "D") +
  geom_abline(intercept = 0, slope = WTP, linetype = "dashed") +
  geom_hline(yintercept = 0) +
  geom_vline(xintercept = 0) +
  ...
  p_tha +
  geom_point(aes(x = QALYs, y = Costs, colour = Strategy), alpha = 0.1) +
  annotate("text", x = -120, y = 2800000, label = "A") +
  annotate("text", x = 120, y = 2800000, label = "B") +
  annotate("text", x = -120, y = -2800000, label = "C") +
  annotate("text", x = 120, y = -2800000, label = "D") +
  geom_abline(intercept = 0, slope = WTP, linetype = "dashed") +
  geom_hline(yintercept = 0) +
  geom_vline(xintercept = 0) +
  facet_wrap(vars(Age), ncol = 1) +
  ...
  scale_y_continuous(
    ...
    breaks = seq(-3000000, 3000000, 1500000)
  ) +
  labs(
    x = "QALYs",
    y = "Costs ($millions)",
